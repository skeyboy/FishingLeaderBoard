...
- (instancetype)initWithImage:(UIImage *)image{
    ...
    if(self){
        ...
        self.frame = CGRectMake(0, 40+Height_StatusBar, SCREEN_WIDTH, SCREEN_HEIGHT-(40+Height_StatusBar));
...
- (void)bindGestureRecognizer{
    ...
    UIPinchGestureRecognizer *pinch = [[UIPinchGestureRecognizer alloc]initWithTarget:self action:@selector(scaleCrop:)];
...
// 缩放
-(void)scaleCrop:(UIPinchGestureRecognizer*)pinchGestureRecognizer {

        UIView *view = _cropView;
