...
- (void)viewDidLoad {
    ...
    head = [[PhotoHeadView alloc]initWithFrame:CGRectMake(0,0, SCREEN_WIDTH, 40+Height_StatusBar)];
...
-(UICollectionView *)showPhotoCollectionView
{
    if (!_showPhotoCollectionView) {
        ...
        _showPhotoCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, CGRectGetMaxY(head.frame), SCREEN_WIDTH, SCREEN_HEIGHT - CGRectGetMaxY(head.frame)) collectionViewLayout:flowLayout];
