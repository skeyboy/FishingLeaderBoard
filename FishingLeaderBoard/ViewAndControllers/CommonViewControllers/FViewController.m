...
-(void)setNavLeftWithTitle:(NSString *)leftTitle
            isShowLeftBack:(BOOL) isShowBack
rightWithTitle:(NSString *)rightTitle
           endWithSelector:(nonnull SEL)rightSelector {
    hkNavigationView = [[FNavigationView alloc] initWithFrame:(CGRect){0, 0, SCREEN_WIDTH, Height_NavBar}];
        hkNavigationView = [[FNavigationView alloc] initWithFrame:(CGRect){0, 0, SCREEN_WIDTH, Height_NavBar}];
          [hkNavigationView setNavBarViewTitle:leftTitle];
    if (isShowBack)
       {
           [hkNavigationView setNavBarViewLeftBtnWithNormalImage:@"nav_back_nor"
                                                highlightedImage:@"nav_back_nor"
    ...
    [hkNavigationView setNavBarViewRightBtnWithTitle:rightTitle
                                         normalImage:nil highlightedImage:nil target:self action: rightSelector?rightSelector:@selector(btnClickBack)];
