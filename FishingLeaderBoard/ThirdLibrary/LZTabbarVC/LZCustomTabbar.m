...
//        UIImage *selectedImage = [UIImage originImage:[UIImage imageNamed:@"game"] scaleToSize:CGSizeMake(70, 70)];
        UIImage *normalImage = [UIImage originImage:[UIImage imageNamed:@"game"] scaleToSize:CGSizeMake(50, 50)];
        UIImage *selectedImage = [UIImage originImage:[UIImage imageNamed:@"game"] scaleToSize:CGSizeMake(50, 50)];
...
//    self.button.center = CGPointMake(self.width/2.0, (self.height - 15 - lz_safeBottomMargin)/2.0);
    self.button.center = CGPointMake(self.width/2.0, (self.height - lz_safeBottomMargin)/2.0);
...
+(UIView*)addTopViewToParentView:(UIView*)parent topLineColor:(UIColor*)lineColor backgroundColor:(UIColor*)backgroundColor{
    ...
    CGPoint p = CGPointMake(parent.bounds.size.width/2.0, 20);
