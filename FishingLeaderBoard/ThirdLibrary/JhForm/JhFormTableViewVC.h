...
@property (nonatomic,strong)NSString * Jh_navLeftImage;

@property (nonatomic, copy) void(^JhClickNavLeftItemBlock)(void);
...
@interface JhFormTableViewVC (setNavBarCategory)
