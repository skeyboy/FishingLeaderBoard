...
-(void)setJh_navLeftImage:(NSString *)Jh_navLeftImage{
       _Jh_navLeftImage = Jh_navLeftImage;
    if (_Jh_navLeftImage.length) {
           UIBarButtonItem *leftItem = [UIBarButtonItem itemWithImage:Jh_navLeftImage highImage:Jh_navLeftImage target:self action:@selector(ClickLeftItem)];
...
-(void)ClickLeftItem{
    if (self.JhClickNavLeftItemBlock) {
...
@end
@implementation JhFormTableViewVC (setNavBarCategory)

-(void)setFishNavTitle:(NSString *)title
{
