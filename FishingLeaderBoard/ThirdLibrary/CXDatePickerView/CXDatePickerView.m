...
- (void)setupUI {
    ...
    self.buttomView.backgroundColor = [UIColor colorWithWhite:0.7 alpha:1];
...
- (void)initPickerHeaderView {
    ...
    CGRect cancelButtonFrame  = CGRectMake(PickerBackViewWeight - 60 - 15-15-60, 0, 60, PickerHeaderHeight);
