 ...
 *  @return Button
 */
+ (MySelButton *)createCustomButtonWithFrame:(CGRect)frame
                                     name:(NSString *)name
                                 delegate:(id)delegate
                                 selector:(SEL)selector
                                      tag:(NSInteger)tag
{
    MySelButton *button = [MySelButton buttonWithType:UIButtonTypeCustom];
 ...
 *  @return Button
 */
+ (MySelButton *)createCustomButtonWithName:(NSString *)name
                                 delegate:(id)delegate
                                 selector:(SEL)selector
                                      tag:(NSInteger)tag
{
