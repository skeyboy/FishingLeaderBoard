...
//    [self performSelector:@selector(hideHud) afterDelay:timeInterval];
    [self performSelector:@selector(hideHud) withObject:nil afterDelay:timeInterval];
}
...
{
    CGSize size = [self.class sizeWithText:info font:[UIFont systemFontOfSize:14] maxSize:CGSizeMake(SCREEN_WIDTH-40, SCREEN_HEIGHT)];
    MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.view animated:YES];
